...
{
    if(mRenderServiceParameters)
    {
        return mRenderServiceParameters->getBaseURL();
    }
...
StringList RenderClient::getOwners()
{
    ...
    stringstream sUrl;
    sUrl << mRenderServiceParameters->getBaseURL();
    sUrl << "/owners";
