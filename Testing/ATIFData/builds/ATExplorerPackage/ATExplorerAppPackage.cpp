...
USEFORM("..\..\source\Forms\TCreateATIFDataProjectForm.cpp", CreateATIFDataProjectForm);
...
USEFORM("..\..\source\Frames\TATIFDataProjectFrame.cpp", ATIFDataProjectFrame); /* TFrame: File Type */
