...
#define MyAppName "ATExplorer"
#define MyAppVersion "0.6.5"
#define MyAppPublisher "Smith Lab"
#define MyAppURL "http://www.example.com/"
#define MyAppExeName "ATExplorer.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId                   = {{3262FF35-FEE3-4DF5-94CD-7AD6CCE516DA}}
AppName                 = {#MyAppName}
...
[Files]
Source: "P:\AppReleases\ATExplorer\ATExplorer.exe";     DestDir: "{app}"; Flags: ignoreversion
Source: "P:\AppReleases\ATExplorer\*";                  DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
